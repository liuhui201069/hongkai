    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        if (result.success) {
                            ...
                            alert("修改成功");
                            edit_td.eq(1).text(data.variety);
                            edit_td.eq(2).text(data.num);
                            edit_td.eq(3).text(data.price);
                            edit_td.eq(4).text(data.unit);
                            edit_td.eq(5).text(data.carPrice);
                            edit_td.eq(6).text(data.carFee);
                            edit_td.eq(7).text(data.total);
                            edit_td.eq(8).text(data.carNumber);
                            edit_td.eq(9).text(data.carOwner);
                            edit_td.eq(10).text(data.date);
                            datas[edit_idx] = data;
                        } else {
            ...
            $(".dc_btn").on("click",function(event){
                event.preventDefault();//使a自带的方法失效，即无法调整到href中的URL
                excelDownLoad("/xjyw/detail_excel");
            });
